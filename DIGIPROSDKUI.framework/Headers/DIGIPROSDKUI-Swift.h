...
@interface NotificationsViewController : UIViewController <APIDelegate>
- (void)sendStatusWithMessage:(NSString * _Nonnull)message error:(enum enumErrorType)error isLog:(BOOL)isLog isNotification:(BOOL)isNotification;
- (void)sendStatusCompletitionWithInitial:(float)initial current:(float)current final:(float)final;
- (void)sendStatusCodeMessageWithMessage:(NSString * _Nonnull)message error:(enum enumErrorType)error;
- (void)didSendErrorWithMessage:(NSString * _Nonnull)message error:(enum enumErrorType)error;
...
@interface NotificationsViewController (SWIFT_EXTENSION(DIGIPROSDKUI)) <DZNEmptyDataSetDelegate, DZNEmptyDataSetSource>
- (NSAttributedString * _Nullable)titleForEmptyDataSet:(UIScrollView * _Nonnull)scrollView SWIFT_WARN_UNUSED_RESULT;
- (NSAttributedString * _Nullable)descriptionForEmptyDataSet:(UIScrollView * _Nonnull)scrollView SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)imageForEmptyDataSet:(UIScrollView * _Nonnull)scrollView SWIFT_WARN_UNUSED_RESULT;
- (NSAttributedString * _Nullable)buttonTitleForEmptyDataSet:(UIScrollView * _Nonnull)scrollView forState:(UIControlState)state SWIFT_WARN_UNUSED_RESULT;
